 ...
 */
public class TextDiagramTaglet implements Taglet {
    ...
    private void generateImage(String text, File outputFile) {
        ...
        RenderedImage image = BitmapRenderer.renderToImage(diagram,
    ...
    public static void register(Map tagletMap) {
        TextDiagramTaglet taglet = new TextDiagramTaglet();
